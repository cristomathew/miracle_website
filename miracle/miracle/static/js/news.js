...
// let morePara = document.querySelectorAll(".section-2 .card .text .para .more-para");
// let readMoreBtn = document.querySelectorAll(".section-2 .card .text .para .more-info-btn");
...
let newsCard = document.querySelectorAll(".section-2 .card");


for(let i=0; i<newsCard.length; i++){

  let current = newsCard[i].querySelector(".text .para .more-info-btn");
  let toggle = false;
  let newsItems = newsCard[i].querySelector(".text .para .more-para");
